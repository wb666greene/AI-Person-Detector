...
def main():
    ...
    QDEPTH = nOVthreads + 1      # bump up for trial of "read queue if full and then write to queue" in camera input thread
...
##    results = Queue(2*Ncameras)
    ...
    # *** setup OvenVINO Movidius AI threads
...
##    print(PTZparam)
    ...
    currentDT = datetime.datetime.now()
    print("[INFO] Fisheye Camera RTSP stream sampling thread" + str(camn) + " is starting..." + currentDT.strftime(" %Y-%m-%d %H:%M:%S"))
